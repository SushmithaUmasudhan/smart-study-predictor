...
- Categorizes performance:
  ...
  - Average
  - Good  
- Provides simple study recommendations  
- Visualizes data using a regression graph  
##  Tech Stack
- Python  
- Pandas  
- Scikit-learn  
...
3. Run all cells  
4. Enter study hours when prompted 
##  Example Output
...
- Add more features like sleep hours, revision time  
##  Author
-SUSHMITHA UMASUDHAN 

## Note

This project is part of my learning journey in AI & Data Science.
